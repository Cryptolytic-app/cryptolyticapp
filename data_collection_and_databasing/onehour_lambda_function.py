    ...
    for exchange in exchanges:
        ...
        for trading_pair in exchanges[exchange]:
            ...
            try:
                ...
                # Define candles for data returned from the API and to only include the actual candle.    
                candles = response['result'][period]
                    
                # Retrieve candles already in database. Collect roughly 24 hours worth of candles.
                ...
                # Take most recent 24 hours worth of candles (24 candles) of the candles returned by the API. 
